  ...
  return (
    ...
    >
      ...
      <div className="custom-input-number__content flex items-center justify-between gap-3 w-[7.5rem] sm:w-32">
        <button
          className="w-8 h-8 rounded flex items-center justify-center border border-slate-500 bg-slate-900 text-white hover:bg-slate-900 focus:outline-none disabled:opacity-50 disabled:cursor-default"
          type="button"
